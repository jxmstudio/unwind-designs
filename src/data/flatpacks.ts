...
export const wanderKits: FlatPackProduct[] = [
  ...
  },
  {
    ...
    shipClass: "oversized",
    upsells: ["cushion-set-eucalyptus"],
    installationRequired: true,
    warranty: "2 years",
    assemblyTime: "4-6 hours",
    sku: "WK-CF-EBH-001",
...
// Premium Kit Products (High-End) - REMOVED: Use premium-troopy-kits-general instead
