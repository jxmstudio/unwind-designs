            ...
            <CardContent className="space-y-6">
              ...
              >
                <motion.div variants={staggerItem}>
                  <h3 className="text-body font-medium text-textPrimary mb-3">Personal Information</h3>
                ...
                <motion.div variants={staggerItem}>
                  <h3 className="text-body font-medium text-textPrimary mb-3">Automatically Collected Information</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-brown-500 rounded-full mt-2 flex-shrink-0"></span>
          ...
          >
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-body-small font-medium text-textPrimary mb-3">Order Processing</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
                ...
                <div>
                  <h3 className="text-body-small font-medium text-textPrimary mb-3">Customer Service</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
                ...
                <div>
                  <h3 className="text-body-small font-medium text-textPrimary mb-3">Marketing & Communication</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
                ...
                <div>
                  <h3 className="text-body-small font-medium text-textPrimary mb-3">Website Improvement</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
          ...
          >
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-body-small font-medium text-textPrimary mb-3">Limited Sharing for Business Operations</h3>
                  <ul className="space-y-2 text-textSecondary text-caption">
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-brown-500 rounded-full mt-2 flex-shrink-0"></span>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Encryption</h4>
                    <p className="text-textSecondary text-caption">
                      SSL encryption for all data transmission and secure storage
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Access Control</h4>
                    <p className="text-textSecondary text-caption">
                      Limited access to personal data on a need-to-know basis
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Regular Audits</h4>
                    <p className="text-textSecondary text-caption">
                      Security assessments and vulnerability testing
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Employee Training</h4>
                    <p className="text-textSecondary text-caption">
          ...
          >
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Access & Update</h4>
                    <p className="text-textSecondary text-caption">
                      View and update your personal information in your account
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Opt-Out</h4>
                    <p className="text-textSecondary text-caption">
                      Unsubscribe from marketing communications at any time
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Data Portability</h4>
                    <p className="text-textSecondary text-caption">
                      Request a copy of your data in a portable format
                    </p>
                  </div>
                  <div className="bg-cream-400 p-4 rounded-lg">
                    <h4 className="text-caption font-medium text-textPrimary mb-2">Deletion</h4>
                    <p className="text-textSecondary text-caption">
