        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="text-sm font-medium text-textPrimary mb-2">30-Day Returns</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm font-medium text-textPrimary mb-2">Warranty Coverage</h3>
                  <p className="text-textSecondary text-xs">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm font-medium text-textPrimary mb-2">Easy Process</h3>
                  <p className="text-textSecondary text-xs">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Unused Products</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Defective Items</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Wrong Items</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Size/Model Issues</h3>
                    <p className="text-textSecondary text-xs">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Used or Installed Items</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Custom Products</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Missing Components</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-3">
                  <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary">Damaged by Customer</h3>
                    <p className="text-textSecondary text-xs">
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary mb-1">Contact Customer Service</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary mb-1">Get Return Authorization</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary mb-1">Package and Ship</h3>
                    <p className="text-textSecondary text-xs">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-textPrimary mb-1">Refund Processing</h3>
                    <p className="text-textSecondary text-xs">
          ...
          >
            ...
            <CardContent>
              <div className="space-y-6">
                <div>
                  <h3 className="text-base font-medium text-textPrimary mb-3">Warranty Coverage</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-cream-400 p-4 rounded-lg">
                      <h4 className="text-sm font-medium text-textPrimary mb-2">Hardware & Fasteners</h4>
                      <p className="text-textSecondary text-xs">1 year warranty</p>
                    </div>
                    <div className="bg-cream-400 p-4 rounded-lg">
                      <h4 className="text-sm font-medium text-textPrimary mb-2">Storage Systems</h4>
                      <p className="text-textSecondary text-xs">2 year warranty</p>
                    </div>
                    <div className="bg-cream-400 p-4 rounded-lg">
                      <h4 className="text-sm font-medium text-textPrimary mb-2">Electrical Components</h4>
                      <p className="text-textSecondary text-xs">3 year warranty</p>
                    </div>
                    <div className="bg-cream-400 p-4 rounded-lg">
                      <h4 className="text-sm font-medium text-textPrimary mb-2">Complete Fitouts</h4>
                      <p className="text-textSecondary text-xs">5 year warranty</p>
                    </div>
                  </div>
                </div>
                
                <div>
                  <h3 className="text-base font-medium text-textPrimary mb-3">What&apos;s Covered</h3>
                ...
                <div>
                  <h3 className="text-base font-medium text-textPrimary mb-3">What&apos;s Not Covered</h3>
                  <ul className="space-y-2 text-textSecondary text-xs">
                    <li className="flex items-start gap-2">
          ...
          >
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="bg-cream-400 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-textPrimary mb-2">Refund Timeline</h3>
                  <p className="text-textSecondary text-xs">
                ...
                <div className="bg-cream-400 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-textPrimary mb-2">Partial Refunds</h3>
                  <p className="text-textSecondary text-xs">
